  ...
  _createClass(MixspaContext, null, [{
    ...
    value: function registerApp(appInfo) {
      if (MixspaContext.hasApp(appInfo.id)) {
        ...
        _storage["default"].put(appInfo.id, MixspaContext._createApp(appInfo));
      }
    }
  }, {
    key: "getApp",
    ...
    key: "_createApp",
    value: function _createApp(appInfo) {
      return new _App["default"](appInfo, appInfo.assets.map(function (asset) {
        return MixspaContext._getOrCreateAsset(asset);
      }));
    }
  }, {
    key: "_getOrCreateAsset",
    value: function _getOrCreateAsset(assetInfo) {
